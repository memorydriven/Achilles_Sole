<?php 
    ...
    $query = "SELECT Product, Description, Category, SKU, Stock, Cost, Price, Image, Weight FROM catalog";
...
<html>
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1.0"/> <!-- Let browser know website is optimized for mobile--> 
         ...
         <link rel="stylesheet" href="css/styles.css">
        <meta charset="UTF-8">
		<title>Achilles Sole Brands - Daniel McDonald</title>
	</head>
  ...
  <div class="row">
      <div class= "container">
       <div class="col s12">
           ...
           <div class = "header_box_top">
            <h1 class="page_header">BRANDS</h1>
      </div>
      </div>
          </div>
      </div>
    ...
    echo'  <div class = "col s6 m4 l3 center-align">
		<div class = "catalog_item">
			<img class="responsive-img" src="'. $row["Image"] . ' " alt="product image" height = "600" width = "700" >
			<p> ' .  $row["Product"] . '</p>
			<p>' . $row["Price"] . '</p>
