...
<html>
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1.0"/> <!-- Let browser know website is optimized for mobile--> 
         ...
         <link rel="stylesheet" href="css/styles.css">
        <meta charset="UTF-8">
		<title>Achilles Sole Account - Daniel McDonald</title>
	</head>
  ...
  <div class="row">
	  ...
	  <div class="col s12">
		...
		<div class="col s12 content_body">
		<h5>CONTACT INFORMATION</h5>
		<p>Name: Achilles</p>
		<p>Email: ouch@myTendon.com</p>
            <a href=#><p>Manage Password</p></a>
		</div>
		</div>
		...
		<div class="col s6 content_body">
            <h5>DEFAULT BILLING ADDRESS</h5> 
		<a href="#"><p>You have not set a default.</p></a>
		</div>
		...
		<div class="col s12 content_body"><a href="#"><p>You do not have any saved cards.</p></a>
		</div>
