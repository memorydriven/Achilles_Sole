...
<html>
  ...
  <div class="row">
      ...
      <div class="col s3">
          ...
          <div class="col s12 sidebar_body center-align" id = "sidebar_checkpoint"><p>Billing Address</p></div>
      ...
      <div class="input-field">
        ...
        <a href = "checkout_guest_shipping_address.php" class="waves-effect waves-light btn blue lighten-2">Continue</a>
