...
<html>
  ...
  <div class="row">
      ...
      <div class="col s3">
          ...
          <div class="col s12 sidebar_body center-align"><p>Shipping Method</p></div>
          <div class="col s12 sidebar_body center-align" id = "sidebar_checkpoint"><p>Payment Method</p></div>
      ...
      <h4>PAYMENT METHOD</h4>
          ...
          <div class = "col s12">
           <img src="http://etaarifa.com/wp-content/uploads/2015/08/paypal_ITSS.jpg" class = "responsive-img" alt="payment methods">
          </div>
          
              <a href="checkout_guest_shipping_method.php" class="waves-effect waves-light btn blue lighten-2">Back</a>
      <a class="waves-effect waves-light btn red darken-5">Complete</a>
        </div>
        </div>
